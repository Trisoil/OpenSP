...
unsigned long Compress(unsigned char *in,unsigned long insize,unsigned char *out)
{
     InType=inMEM;
     InData=in;
     InDataSize=insize;
...
unsigned long UnCompress(unsigned char *in,unsigned long insize,unsigned char *out)
{
     InType=inMEM;
     InData=in;
     InDataSize=insize;
